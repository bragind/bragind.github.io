...
\begin{center}
    ...
    \href{https://t.me/DmitiyBragin}{Telegram} \textbar{} 
...
\section*{Цель}
Инженер с 16+ годами опыта в IT, в настоящее время специализируюсь в разработке на  Python и C/C++, автоматизации и ML. Ищу позицию, Systems Engineer / AI Integrator
...
\begin{itemize}
    ...
    \item \textbf{RAG-платформа для семантического поиска технических статей} — парсер, ChromaDB, Ollama, Telegram-bot
